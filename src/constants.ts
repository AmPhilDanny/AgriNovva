...
export const INITIAL_PRODUCE: ProduceItem[] = [
  { id: "p1", title: "Premium Organic Brown Rice", farmerName: "Muthoni Farms", location: "Kirinyaga, Kenya", category: "organic", grade: "premium", pricePerKg: 2.80, availableQty: 5000, organicCert: true, image: "https://images.unsplash.com/photo-1586201375761-83865001e31c?w=600&q=80", rating: 4.8, harvestDate: "2025-03-10", description: "Hand-harvested organic brown rice from the foothills of Mt. Kenya. Naturally grown without pesticides." },
  { id: "p2", title: "Fresh Vine Tomatoes", farmerName: "Green Valley Co-op", location: "Nakuru, Kenya", category: "vegetables", grade: "premium", pricePerKg: 1.50, availableQty: 2000, organicCert: false, image: "https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=600&q=80", rating: 4.5, harvestDate: "2025-03-14", description: "Plump, vine-ripened tomatoes harvested fresh daily. Perfect for salads and sauces." },
  { id: "p3", title: "Sweet Kenyan Mangoes", farmerName: "Coast Tropical Fruits", location: "Mombasa, Kenya", category: "fruits", grade: "premium", pricePerKg: 1.80, availableQty: 3000, organicCert: false, image: "https://images.unsplash.com/photo-1553279768-865429fa0078?w=600&q=80", rating: 4.9, harvestDate: "2025-03-12", description: "Sun-ripened sweet mangoes from the Kenyan coast. Naturally juicy and fiber-free." },
  { id: "p4", title: "Grade A White Maize", farmerName: "Rift Valley Grains", location: "Uasin Gishu, Kenya", category: "grains", grade: "standard", pricePerKg: 0.65, availableQty: 10000, organicCert: false, image: "https://images.unsplash.com/photo-1551754655-cd27e38d2076?w=600&q=80", rating: 4.2, harvestDate: "2025-02-28", description: "High-yield white maize from the breadbasket of Kenya. Dried and graded for quality." },
  { id: "p5", title: "Organic Free-Range Eggs", farmerName: "Happy Hens Farm", location: "Kiambu, Kenya", category: "dairy-poultry", grade: "premium", pricePerKg: 3.50, availableQty: 800, organicCert: true, image: "https://images.unsplash.com/photo-1582722872445-44dc5f7e3c8f?w=600&q=80", rating: 4.7, harvestDate: "2025-03-15", description: "Farm-fresh free-range eggs from pasture-raised hens. Rich in omega-3 and flavor." },
  { id: "p6", title: "Fresh Kale (Sukuma Wiki)", farmerName: "Highlands Greens", location: "Nyeri, Kenya", category: "vegetables", grade: "standard", pricePerKg: 0.80, availableQty: 1500, organicCert: false, image: "https://images.unsplash.com/photo-1522184216316-3c25379f9720?w=600&q=80", rating: 4.3, harvestDate: "2025-03-13", description: "Crisp, dark green kale bunches harvested daily. Staple green for every Kenyan kitchen." },
  { id: "p7", title: "Organic Avocados (Fuerte)", farmerName: "Muthoni Farms", location: "Muranga, Kenya", category: "organic", grade: "premium", pricePerKg: 2.20, availableQty: 2500, organicCert: true, image: "https://images.unsplash.com/photo-1523049673857-eb18f1d7b578?w=600&q=80", rating: 4.9, harvestDate: "2025-03-11", description: "Creamy Fuerte avocados grown organically in the central highlands. Export quality." },
  { id: "p8", title: "Fresh Cow Milk", farmerName: "Dairy Gold Co-op", location: "Nandi, Kenya", category: "dairy-poultry", grade: "premium", pricePerKg: 0.90, availableQty: 3000, organicCert: false, image: "https://images.unsplash.com/photo-1624628639859-c31b5e6e5c0b?w=600&q=80", rating: 4.4, harvestDate: "2025-03-15", description: "Fresh pasteurized whole milk from grass-fed Ayrshire cows. Delivered chilled." },
  { id: "p9", title: "Sorghum Grain", farmerName: "Eastern Drylands Farm", location: "Kitui, Kenya", category: "grains", grade: "economy", pricePerKg: 0.50, availableQty: 6000, organicCert: false, image: "https://images.unsplash.com/photo-1590259223388-aa2e5b3093af?w=600&q=80", rating: 4.0, harvestDate: "2025-02-20", description: "Drought-resistant sorghum grain from semi-arid regions. Ideal for flour and animal feed." },
  { id: "p10", title: "Passion Fruit", farmerName: "Coast Tropical Fruits", location: "Kwale, Kenya", category: "fruits", grade: "premium", pricePerKg: 3.00, availableQty: 1200, organicCert: false, image: "https://images.unsplash.com/photo-1604068549290-dea0e4a305ca?w=600&q=80", rating: 4.6, harvestDate: "2025-03-14", description: "Sweet-tart passion fruits bursting with flavor. Perfect for juice and desserts." },
];

export const INITIAL_SHIPMENTS: SupplyChainShipment[] = [
  {
    id: "s1", produceTitle: "Premium Organic Brown Rice", origin: "Kirinyaga, Kenya", destination: "Nairobi Wholesale Market", status: "in-transit",
  ...
  {
    id: "s2", produceTitle: "Fresh Vine Tomatoes", origin: "Nakuru, Kenya", destination: "Mombasa Port", status: "pending",
  ...
  {
    id: "s3", produceTitle: "Sweet Kenyan Mangoes", origin: "Mombasa, Kenya", destination: "Nairobi Fresh Market", status: "delivered",
...
export const MARKET_PRICES: MarketPrice[] = [
  { commodity: "Organic Brown Rice", price: "KSh 145", change: 3.2, unit: "/kg", trend: "up" },
  { commodity: "White Maize", price: "KSh 42", change: -1.5, unit: "/kg", trend: "down" },
  { commodity: "Tomatoes", price: "KSh 85", change: 1.8, unit: "/kg", trend: "up" },
  { commodity: "Mangoes", price: "KSh 110", change: 2.5, unit: "/kg", trend: "up" },
  { commodity: "Avocados", price: "KSh 130", change: -0.8, unit: "/kg", trend: "down" },
  { commodity: "Kale (Sukuma Wiki)", price: "KSh 45", change: 0.5, unit: "/bunch", trend: "stable" },
  { commodity: "Free-Range Eggs", price: "KSh 520", change: 4.1, unit: "/tray", trend: "up" },
  { commodity: "Fresh Milk", price: "KSh 65", change: 1.2, unit: "/liter", trend: "up" },
  { commodity: "Sorghum", price: "KSh 38", change: -0.3, unit: "/kg", trend: "down" },
  { commodity: "Passion Fruit", price: "KSh 180", change: 5.0, unit: "/kg", trend: "up" },
];
